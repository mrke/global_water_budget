...
if (p==2){
JanEtstriata[w]<-sum(masbal$H2OEvap_g[which(masbal$JULDAY==15)])
JulyEtstriata[w]<-sum(masbal$H2OEvap_g[which(masbal$JULDAY==196)])
}
if (p==3){
...
if (p==1){write.csv(masbal, file="masbal_minpwet_striata.csv")
  write.csv(environ, file="environ_minpwet_striata.csv")} 
if (p==3){write.csv(masbal, file="masbal_maxpwet_striata.csv")
  write.csv(environ, file="environ_maxpwet_striata.csv")}
if (p==2){write.csv(masbal, file="masbal_striata.csv")
  write.csv(environ, file="environ_striata.csv")}
#}#end p loop
# 
