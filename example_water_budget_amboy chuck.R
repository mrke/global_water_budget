...
#c(amboy,granites)
sites<-cbind(c(-115.770834,34.554573),c(-115.688707,34.744437))
...
############## location and climatic data  ###################################
  ...
  longlat<-c(sites[1,w],sites[2,w]) # type a long/lat here in decimal degrees, used if option 0 is chosen above
